...
function PredictiveSearch() {
  ...
  const handleSubmit = (event: React.SubmitEvent<HTMLFormElement>) => {
    ...
    const selected =
      resolvedActiveIndex >= 0 ? results[resolvedActiveIndex] : results[0];
    if (!selected) return;
  ...
  return (
    <div
      ref={searchRef}
      className="relative mx-3 hidden w-full max-w-sm md:block"
    >
